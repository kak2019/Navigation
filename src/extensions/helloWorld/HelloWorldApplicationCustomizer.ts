...
export default class HelloWorldApplicationCustomizer
  ...
  public onInit(): Promise<void> {
    ...
    const head1: any = document.getElementById('spSiteHeader') || document.documentElement;
    ...
    var selectedstyle;
    const innerHTML ='<div id="root"><div class="t-head-menu t-menu--dark"><div class="t-head-menu__inner"><ul class="t-menu"><li class="t-menu__item t-menu__item--plain"><span class="t-menu__content"><a className="unselectedItem" id="Home" href="https://udtrucks.sharepoint.com/sites/ExtensionsTEST">Home3</a></span></li><li class="t-menu__item t-menu__item--plain"><span class="t-menu__content"><a id="Delivery" href="https://udtrucks.sharepoint.com/sites/ExtensionsTEST/SitePages/Delivery.aspx">Delivery Practice & Framework</a></span></li><li class="t-menu__item t-menu__item--plain"><span class="t-menu__content"><a id="Integration" href="https://udtrucks.sharepoint.com/sites/ExtensionsTEST/SitePages/Integration.aspx">Integration & Architecture</a></span></li><li class="t-menu__item t-menu__item--plain"><span class="t-menu__content"> <a id="UX" href="https://udtrucks.sharepoint.com/sites/ExtensionsTEST/SitePages/UX.aspx">UX</a></span></li><li class="t-menu__item t-menu__item--plain"><span class="t-menu__content"><a id="AI" href="https://udtrucks.sharepoint.com/sites/ExtensionsTEST/SitePages/AI.aspx">AI</a></span></li><li class="t-menu__item t-menu__item--plain"><span class="t-menu__content"><a id="RPA" href="https://udtrucks.sharepoint.com/sites/ExtensionsTEST/SitePages/RPA.aspx">RPA</a></span></li><li class="t-menu__item t-menu__item--plain"><span class="t-menu__content"> <a id="DocumentManagement" href="https://udtrucks.sharepoint.com/sites/ExtensionsTEST/SitePages/DocumentManagement.aspx">Document Management</a></span></li><li class="t-menu__item t-menu__item--plain"><span class="t-menu__content"><button id="LowcodeandMobile" onclick="{loadstyle();this.className=&quot;selectedItem&quot;}">Low code and Mobile</button></span></li><li class="t-menu__item t-menu__item--plain"><span class="t-menu__content"><button id="Community" onclick="{loadstyle();this.className=&quot;selectedItem&quot;}">Community</button></span></li></ul></div></div></div>'
